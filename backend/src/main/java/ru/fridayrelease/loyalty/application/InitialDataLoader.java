        ...
        if (0 == tasks) {
            ...
            this.mongoTemplate.save(
                    Task.builder()
                            ...
                            .state(TaskState.IN_PROGRESS)
                            .tenantId(TENANT_ID)
                            .description("Установите мобильное приложение Райффайзен Бизнес и войдите под своей учетной записью. Подробнее о мобильном банке смотрите в соответствующем разделе.")
                            .progress(Task.Progress.builder()
                                    .current(0)
                                    .all(1)
                                    .build())
